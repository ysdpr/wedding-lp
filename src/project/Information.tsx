...
const Information = () => {
  ...
  return (
    ...
    // <div className="w-[100vw] py-12 px-6 md:py-24 bg-ex">
    <div ref={ref} className="w-[100vw] bg-[#c1e4e9] py-12 px-6 md:py-24 bg-ex">
      <div className="md:w-[720px] m-auto">
        ...
        <div className="md:m-auto md:w-[320px]">
          <h2 className="text-2xl text-center top2">ご案内</h2> {/* TODO: 見出しの装飾を作る */}
          <div className="">
        ...
        <div className="md:m-auto md:w-[320px]">
          ...
          <h2 className="text-2xl text-center mt-8 top2">アクセス</h2>
